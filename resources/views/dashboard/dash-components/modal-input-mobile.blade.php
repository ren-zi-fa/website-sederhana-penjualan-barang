                ...
                <form action="/dashboard/kelolaproducts" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center justify-center w-full">
                        ...
                        <label for="imageMobile"
                            ...
                            <img  class="w-full absolute top-0  "
                                id="frameImage" >
                            ...
                            <input onchange="previewImage()" id="imageMobile" type="file" class="hidden" name="image" />
                        </label>
                    </div>
                    ...
                    <div
                        ...
                        <button data-modal-hide="main-modal" type="button"
...
<script>
    function previewimage() { frameImage.src=URL.createObjectURL(event.target.files[0]); }
</script>