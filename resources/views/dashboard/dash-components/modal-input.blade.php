                    ...
                    <div class="grid gap-6 mb-6 ">
                        <div>
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                value="{{old('name')}}" placeholder="sempak ragil">
                                @error('name')
                        ...
                        <div>
                            ...
                            <input type="text" id="description" name="description"
                                ...
                                placeholder="langka dan berkualitas">
                                @error('description')
                                <div class="text-red-500 font-medium">{{$message}}</div>
                                @enderror
                        </div>
                        ...
                        <div class="mx-auto flex items-center justify-center w-1/2">
                            <label for="dropzone-file"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                            class="font-semibold">upload</span> gambar nya disini</p>
